...
function PortfolioSky() {
 return <div className="portfolio-sky" aria-hidden="true"><div className="sky-stars" /><img className="sky-logo" src="/img/banner/BannerLogo.png" alt="" /><div className="sky-islands"><img className="sky-palace" src="/img/banner/PalaceZeal.png" alt="" /><img className="sky-shrine" src="/img/banner/SunShrineZeal.png" alt="" /><img className="sky-enhasa" src="/img/banner/EnhasaZeal.png" alt="" /></div><div className="sky-clouds" /><span className="sky-caption">A COLLECTION OF IDEAS BROUGHT TO LIFE</span></div>;
}
export default function Portfolio() {
 ...
 <section className="portfolio-note"><p className="eyebrow">WORKING WITH AI</p><h2>Clear direction. Hands-on validation.</h2><p>I use AI across research, implementation, and creative production. I define the intended result, communicate constraints, test what comes back, and give specific feedback for the next pass. When an approach works, I turn it into a repeatable workflow.</p><p>My role spans concept development, creative direction, technical decisions, and practical testing. AI expands the range of work I can explore; checking the result remains part of the job.</p></section><aside className="portfolio-note"><h2>An evolving collection.</h2><p>From everyday workflows to expressive interfaces, each project is a place to learn, test, and improve.</p></aside></div></main>;
}
